...
{
    $menu = '<li class="nav-item"><a class="nav-link" href="index.php">お気に入り登録</a></li><li class="nav-item"><a class="nav-link" href="select.php">お気に入り一覧</a></li>';
    // $menu .= '<li class="nav-item"><a class="nav-link" href="bm_logout.php">ログアウト</a></li>';
    return $menu;
}
