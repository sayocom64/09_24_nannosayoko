...
<body>
    ...
    <form action="update.php" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" value="<?=$rs['title']?>" readonly>
        </div>
        <div class="form-group">
            <label for="author">著者名</label>
            <input type="text" class="form-control" id="author" name="author" value="<?=$rs['author']?>" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="comment" rows="3" name="comment" readonly><?=$rs['comment']?></textarea>
        </div>
        <div class="form-group">
